...
function startRecording() {
  ...
  $('#text-state').html(
    'Aku mendengarmu.... <br> Tekan tombol di bawah untuk mendapatkan yang kamu inginkan.'
  );
  ...
  navigator.mediaDevices
    ...
    .catch(function(err) {
      ...
      $('#text-state').html(
        'Klik tombol di bawah dan katakan apa yang ingin kamu tahu!'
      );
    });
}
...
function getResult(data) {
  if (data.includes('lihat anjing')) {
    ...
    $('#modal-text-content').html(
      'Kambing adalah salah satu jenis ternak penghasil daging dan susu yang sudah lama dikenal petani dan memiliki potensi sebagai komponen usaha tani yang penting di berbagai agri-ekosistem.'
    );
    $('#modal-text').attr('class', 'modal is-active');
    ...
    $('#modal-text-content').html(
      'Ular adalah reptilia tak berkaki yang bertubuh panjang. Ular memiliki sisik seperti kadal dan sama-sama digolongkan ke dalam reptil bersisik (Squamata). Perbedaannya adalah kadal pada umumnya berkaki, memiliki lubang telinga, dan kelopak mata yang dapat dibuka tutup.'
    );
    $('#modal-text').attr('class', 'modal is-active');
  } else if (data.includes('suara anjing')) {
    $('#modal-text-title').html('Suara Anjing');
    $('#modal-text-content').html(
      'Dengarkan suara ini... <br> <a class="button is-primary" onclick="audioAnjing.play()">Putar lagi</a> '
    );
    $('#modal-text').attr('class', 'modal is-active');
    audioAnjing.play();
    ...
    $('#modal-text-content').html(
      'Dengarkan suara ini... <br> <a class="button is-primary" onclick="audioAyam.play()">Putar lagi</a> '
    );
    $('#modal-text').attr('class', 'modal is-active');
    audioAyam.play();
    ...
    $('#modal-text-content').html(
      'Dengarkan suara ini... <br> <a class="button is-primary" onclick="audioKambing.play()">Putar lagi</a> '
    );
    $('#modal-text').attr('class', 'modal is-active');
    audioKambing.play();
    ...
    $('#modal-text-content').html(
      'Dengarkan suara ini... <br> <a class="button is-primary" onclick="audioKucing.play()">Putar lagi</a> '
    );
    $('#modal-text').attr('class', 'modal is-active');
    audioKucing.play();
    ...
    $('#modal-text-content').html(
      'Dengarkan suara ini... <br> <a class="button is-primary" onclick="audioSapi.play()">Putar lagi</a> '
    );
    $('#modal-text').attr('class', 'modal is-active');
    audioSapi.play();
    ...
    $('#modal-text-content').html(
      'Dengarkan suara ini... <br> <a class="button is-primary" onclick="audioUlar.play()">Putar lagi</a> '
    );
    $('#modal-text').attr('class', 'modal is-active');
    audioUlar.play();
  }
